...
//   myFont = loadFont('ASSET/FONTS/AbrilFatface-Regular.ttf');
  xml = loadXML('ASSET/COLORS/vintage.xml');
  sound = loadSound('../_MP3/Dexter_Britain_-_01_-_The_Time_To_Run_Finale.mp3');
}
...
function render(percent) {
    ...
    for (let a = 0; a < TWO_PI; a += pasBo) {
        ...
        translate(x,y*pow(valSize,0.7)*trans,z*valSize*trans);
        ...
        // switch(true){
        //   case (level<.5):
        //     sphere(pow(percent,0.1));
        //     break;
        //   case (level>2 && level<2.5):
        //     sphere(8);
        //     break;
        //   default:
        //       ellipsoid(x*pow(percent,0.1),10+4*pow(valSize,0.8),2+4*pow(valSize,0.8));
