...
function setup() {
    ...
    velocity = createVector(0,random(-2,2));
...
function draw() {
    ...
    velocity.x = map(cos(frameCount*0.001),-1,1,-0.5,0.5);
...
function render(percent) {
    ...
    for (let a = 0; a < TWO_PI; a += pasBo) {
        ...
        translate(0,x*pow(valSize,0.7),y*valSize);
        ...
        box(x*pow(percent,0.9)*0.4,6*valSize,10);
