...
let endPhi;
let diffPhi;
var pasBo, volume = 0, freqX, freqY, freqZ, scaleZ, modFreqX,modFreqY,modFreqZ, noiseMax, totalFrames, spd, rotX, rotY, rotZ, size, rotFxX, rotFixY,rotFixZ, valShearX,valShearY;
let canvas;
let angleGen = 1;
let pan = 0.1;
var gui, gui2;
...
function preload() {
  ...
  xml = loadXML('ASSET/COLORS/dark-black.xml');
...
function render(percent) {
    ...
    push();
    translate(sin(angle*3)*30,cos(angle)*-200,0);
