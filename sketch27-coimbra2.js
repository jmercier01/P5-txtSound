...
function render(percent) {
    ...
    for (let a = 0; a < TWO_PI; a += pasBo) {
        ...
        if (mouseIsPressed) {
            ...
            //V1
            push();
            translate(szuoff*5,szuoff*10,0);
            rotateX(frameCount*0.1);
            ellipsoid((liss.x*percent*valSize*0.1)*szuoff,(liss.x*percent*valSize*0.5)*szuoff,(liss.x*percent*valSize*0.1)*szuoff);
            pop();
            
            // v2
            //ellipsoid((liss.x*percent*valSize*0.5)*szuoff,(liss.x*percent*valSize*0.5)*szuoff,(liss.x*percent*valSize*0.5)*szuoff);
